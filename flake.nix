...
# along with this program.  If not, see <https://www.gnu.org/licenses/>.
{
  ...
  inputs = rec {
    ...
    pythoneda-runtime-secrets = {
      ...
      url = "github:pythoneda-runtime-def/secrets/0.0.15";
    };
    pythoneda-shared-pythonlang-banner = {
      inputs.flake-utils.follows = "flake-utils";
      inputs.nixpkgs.follows = "nixpkgs";
    ...
    pythoneda-shared-runtime-secrets-events = {
      ...
      inputs.pythoneda-shared-pythonlang-domain.follows =
        "pythoneda-shared-pythonlang-domain";
      url =
        "github:pythoneda-shared-runtime-def/secrets-events/0.0.16";
    };
    pythoneda-shared-runtime-secrets-events-infrastructure = {
      ...
      inputs.pythoneda-shared-pythonlang-domain.follows =
        "pythoneda-shared-pythonlang-domain";
      url =
        "github:pythoneda-shared-runtime-def/secrets-events-infrastructure/0.0.16";
    };
  };
  outputs = inputs:
    with inputs;
